...
from src.vista.v_scroll import *
 
 
class Tabla:
    
    def __init__(
        self, master, titulo_ventana, fichero, filas, columnas, alto, 
        ancho):
        ...
        self.__botonCargar = Button(
            self.__botones, text = "Mostrar aviones", 
            command = self.cargar)
        ...
        self.__filas = filas; self.__columnas = columnas
        self.__celdas = [[None for i in range(self.__columnas)] for j in range(self.__filas)]
