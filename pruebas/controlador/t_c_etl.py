...
controlador_etl.set_fichero_aviones(
    vista_etl.get_etiqueta_fichero_aviones(), "./ficheros/aviones.csv"
)
controlador_etl.set_fichero_vuelos(
    vista_etl.get_etiqueta_fichero_vuelos(), "./ficheros/geslot_marzo_22.csv"
)
